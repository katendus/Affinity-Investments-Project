...
<head>
  <meta charset="utf-8">
    ...
    <title>Affinity Investments - Admin Login</title>
...
<body class="hold-transition theme-primary bg-gradient-primary">
	...
	<div class="content-top-agile p-10">
		<h2 class="text-white">Affinity Investments</h2>
			  ...
			  <div class="row">
				...
				<div class="col-6">
				 <div class="fog-pwd text-right">
					<!-- 					<a href="<?php echo e(route('password.request')); ?>" class="text-white hover-info"><i class="ion ion-locked"></i> Forgot pwd?</a>
 -->
					<br>
				  </div>
				</div>
...
<?php /**PATH /home/ysx5xox21f3t/public_html/ppg/resources/views/auth/admin_login.blade.php ENDPATH**/ ?>