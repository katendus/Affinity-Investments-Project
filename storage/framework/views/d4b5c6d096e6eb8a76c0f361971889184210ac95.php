  <header class="main-header">
    ...
    <div>
      ...
      <a href="#" class="waves-effect waves-light rounded dropdown-toggle p-0" data-toggle="dropdown" title="User">
        <img src="<?php echo e((!empty($adminData->profile_photo_path))? url('upload/admin_images/'.$adminData->profile_photo_path):url('upload/no_image.jpg')); ?>" alt="">
      </a>
...
<?php /**PATH /home/ysx5xox21f3t/public_html/ppg/resources/views/admin/body/header.blade.php ENDPATH**/ ?>